"""Trial 1 of change combo component, this will trial the user entering the
specific item they want to change"""
...
while True:
    ...
    if change == "Combo name":
        ...
        if item_change not in new_combo[combo_name]:
        ...
        # Give error message if item does not exist
        if price_change not in new_combo[combo_name]:
